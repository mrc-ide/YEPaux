...
#'
#' @details This function plots a graph based on one or more datasets generated by get_mcmc_datasets_multichain(),
...
#'
#'   Note that this function is used when a separate set of spillover FOI and R0 values is desired for
#'   each chain; for a single set of spillover FOI and R0 values, the chains can be combined using
#'   combine_multichain() and values calculated using get_mcmc_FOI_R0_data().
#'
#' @param datasets List containing one or more datasets, generated by get_mcmc_datasets_multichain()
#' @param datasets_selected Vector of dataset numbers to be selected from list
#' @param burnin_values Vector of burn-in iteration values (1 per dataset) before which data discarded (defaults to 1)
...
#'   Note that this function is used when a separate set of spillover FOI and R0 values is desired for
#'   each chain; for a single set of spillover FOI and R0 values, the chains can be combined using
#'   combine_multichain() and values calculated using get_mcmc_enviro_coeff_data().
#'
#' @param datasets List containing one or more datasets, generated by get_mcmc_datasets_multichain()
#' @param datasets_selected Vector of dataset numbers to be selected from list
#' @param burnin_values Vector of burn-in iteration values (1 per dataset) before which data discarded (defaults to 1)
...
#-------------------------------------------------------------------------------
#' @title get_mcmc_additional_params_multichain
#'
...
#' @param burnin_values Vector of burn-in iteration values (1 per dataset) before which data discarded (defaults to 1)
#' @param end_values Vector of end iteration values (1 per dataset) after which data discarded (defaults to chain ends)
#' @param parameters Vector of names of parameters to be extracted
#'
#' @export
#'
...
#-------------------------------------------------------------------------------
#' @title combine_multichain
#'
#' @description Combine the post-burnin values from multiple Markov chains into one data frame
#'
#' @details [TBA]
#'
#' @param datasets List containing one or more datasets, generated by get_mcmc_datasets_multichain()
